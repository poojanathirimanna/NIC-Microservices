    ...
    <div style={styles.container}>
      ...
      <div style={styles.resetWrapper}>
        ...
        <div style={styles.brandSection} className={mounted ? 'slide-down' : ''}>
          ...
          <p style={styles.brandSubtitle}>Reset Your Account Password</p>
        </div>

        {/* Reset Card */}
        <div style={styles.resetCard} className={mounted ? 'fade-in-up' : ''}>
          <div style={styles.cardHeader}>
            <h2 style={styles.welcomeTitle}>Reset Password</h2>
            <p style={styles.welcomeSubtitle}>Enter your details to reset your password</p>
          </div>
          ...
          <div style={styles.actionLinks}>
            <div style={styles.linkGroup}>
              <span style={styles.linkText}>Remember your password?</span>
              <button
                onClick={goToLogin}
      ...
      <style>{`
        ...
        .reset-btn-hover:hover:not(:disabled) {
